...
const NotificationForm = () => {
  ...
  const handleBack = () => {
    history.push("/family/notification");
  };
  const listApproveBy = [
    {
      name: "TEACHER",
  ...
  const handleSubmit = (values) => {
    ...
    dispatch(addNotification("/notification/family", params, history));
    //   console.log("add");
    // } else {
    //   params.id = id;
    //   dispatch(updateNotification("/notification/family", params, history));
    //   console.log("update");
    // }
  };
