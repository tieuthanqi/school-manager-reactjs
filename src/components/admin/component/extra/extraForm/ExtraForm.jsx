...
const ExtraForm = () => {
  ...
  const handleSubmit = (values) => {
    ...
    console.log(values);
    if (id === -1) {
      dispatch(addExtra("/extracurricular-activities/admin", params, history));
      console.log("add");
      console.log(params);
    } else {
      params.id = id;
      console.log(params);
      dispatch(
        updateExtra("/extracurricular-activities/admin", params, history)
      );
      console.log("update");
    }
      ...
      >
        <div className="container text-center">
          ...
          <Form>
            ...
            <div className="row">
              <TextField label="Hoạt động" name="title" type="text" />
