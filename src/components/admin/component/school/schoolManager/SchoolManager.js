...
import { getAllSchool, deleteSchool  } from "../../../../../services/school-service";
...
const SchoolManager =()=>{
    ...
    const handleDelete = (item) => {
        if(confirm('Bạn có muốn xóa thông tin trường ' + item.id + ' ?')){ //eslint-disable-line
        ...
        <div>
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div className="card-table">
                    ...
                    <Link to='school/add'>
                    <button className="btn mb-10 btn-success">
                        Thêm mới
                    </button>
                    </Link>
